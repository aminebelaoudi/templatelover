				...
				<div class="tl-sp__info">
					<div class="tl-sp__info-inner">
						...
						<?php if ( $product->is_purchasable() && $product->is_in_stock() ) : ?>
							...
							<form class="tl-sp__cart-form cart" method="post" enctype="multipart/form-data" data-product_id="<?php echo esc_attr( $product_id ); ?>">
								...
								<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product_id ); ?>" class="tl-sp__add-to-cart single_add_to_cart_button alt" data-product_id="<?php echo esc_attr( $product_id ); ?>">
									<span class="tl-sp__add-to-cart-text">
									...
									<span class="tl-sp__add-to-cart-loading" aria-hidden="true">
									...
									<span class="tl-sp__add-to-cart-done" aria-hidden="true">
